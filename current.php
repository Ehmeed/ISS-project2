...
<head>
    ...
    <title>Aktulání projekty - Fakultní informační systém</title>
        ...
        <ul class="nav nav-list accordion">
            ...
            <li class="nav-header">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="subjects.php">Zapsané</a></li>
                    <li><a href="all_subjects.php">Všechny</a></li>
                </ul>
            </li>
