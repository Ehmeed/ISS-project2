...
<!--Obsah stranky-->          
			...
			<a href="create_version.php?id_projekt=<?php echo $id?>" class="link"><button class="tlacitko"><h4>VYTVOŘIT VARIANTU</h4></button></a><br><br>
            ...
            <table>
			    ...
			    $query = "SELECT DISTINCT varianta.id_varianta, varianta.maximum_resitelu, varianta.nazev FROM varianta WHERE projekt = $id";
				...
				<tr> 
                  	 <td><a href="version.php?id_varianta=<?php echo $data_array[0]?>"><?php echo $data_array[2]?></a></td>
